...
FROM shipment_logs;`);
  ...
  const expectedQuery = `
SELECT
    'WH_DEL_01' AS warehouse_id,
    2 AS suspicious_shipments

UNION ALL

SELECT
    'WH_MUM_03' AS warehouse_id,
    2 AS suspicious_shipments
`;
...
try {
  ...
  suspicious_shipments: Number(row.suspicious_shipments),
}));
...
const cleanedExpected = expectedRows.map((row: any) => ({
  ...
  if (
    ...
    JSON.stringify(cleanedExpected)
  ) {
    setSolved(true);
  } else {
    setSolved(false);
      ...
      <div className="grid grid-cols-12 gap-6 items-start">
        ...
        <div className="col-span-3 bg-zinc-900 rounded-2xl p-6 border border-zinc-800 sticky top-6">
          ...
          <p className="text-zinc-300 leading-8">
            Audit teams discovered several shipments marked as DELIVERED
without outbound warehouse scan confirmations.
Certain facilities appear to manipulate shipment records.
          </p>
          ...
          <div className="mt-8 bg-black border border-zinc-700 rounded-xl p-4">
            ...
            <p className="text-zinc-300 leading-7">
              Identify the warehouses with more than 1 delivered shipment. Name the delivered shipment count as suspicious_shipments.
            </p>
...
<div className="mt-4 pt-4 border-t border-zinc-700">
  ...
  <div className="bg-zinc-950 rounded-lg p-3 text-xs text-cyan-400 font-mono overflow-x-auto whitespace-nowrap">
    ...
    S002 | WH_BLR_09 | P201 | 125000 | MISSING
...
<div className="mt-4 pt-4 border-t border-zinc-700">
  ...
  <div className="bg-zinc-950 rounded-lg p-3 text-xs text-cyan-400 font-mono overflow-x-auto whitespace-nowrap">
    ...
    WH_BLR_09 | Bangalore | Ravi Kumar
            ...
            <div className="mt-6">
              ...
              {solved ? (
                ...
                <div className="bg-green-500/10 border border-green-500 rounded-2xl p-6 animate-pulse shadow-lg shadow-green-500/20">
                  ...
                  <p className="text-zinc-300 leading-7">
                    You identified the product category driving the suspicious shipment losses.
                  </p>
                  <button
                  onClick={() =>
  router.push("/series/supply-chain-detective/episode-4")
}
...
>
  Continue to Episode 4 →
                ...
                <div className="bg-red-500/10 border border-red-500 rounded-2xl p-6">
                  ...
                  <p className="text-zinc-300 leading-7">
                    The scan audit evidence is incomplete.
Review your grouping and HAVING conditions carefully.
                  </p>
                ...
                <div className="bg-yellow-500/10 border border-yellow-500 rounded-2xl p-6">
                  ...
                  <p className="text-zinc-300 leading-7">
                    Run your SQL investigation to uncover suspicious warehouse delivery patterns.
                  </p>
          ...
          <div className="bg-zinc-900 border border-zinc-700 rounded-2xl p-8 w-[500px]">
            ...
            {!revealHint ? (
              ...
              <div>
                ...
                <p className="text-zinc-300 leading-7 mb-6">
                  Focus only on DELIVERED shipments.
Group warehouse activity and filter warehouses
with suspiciously high delivered shipment counts.
                </p>
