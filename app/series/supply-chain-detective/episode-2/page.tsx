      ...
      <div className="grid grid-cols-12 gap-6 items-start">
        ...
        <div className="col-span-3 bg-zinc-900 rounded-2xl p-6 border border-zinc-800 sticky top-6">
          ...
          <p className="text-zinc-300 leading-8">
            Several shipments disappeared after leaving Bangalore
warehouses. Transit records indicate suspicious activity
linked to specific product categories.
          </p>
          ...
          <div className="mt-8 bg-black border border-zinc-700 rounded-xl p-4">
            ...
            <p className="text-zinc-300 leading-7">
              Find the product category with the highest missing inventory value.Name the value column as lost_value.
            </p>
            ...
            <div className="mt-6">
              ...
              {solved ? (
                ...
                <div className="bg-green-500/10 border border-green-500 rounded-2xl p-6 animate-pulse shadow-lg shadow-green-500/20">
                  ...
                  <button
                  onClick={() =>
  router.push("/series/supply-chain-detective/episode-3")
}
...
>
  Continue to Episode 3 →
                ...
                <div className="bg-red-500/10 border border-red-500 rounded-2xl p-6">
                  ...
                  <p className="text-zinc-300 leading-7">
                    The shipment evidence is incomplete.
Review the joins and aggregation carefully.
                  </p>
                ...
                <div className="bg-yellow-500/10 border border-yellow-500 rounded-2xl p-6">
                  ...
                  <p className="text-zinc-300 leading-7">
                    Run your SQL investigation to uncover which product category is driving shipment losses.
                  </p>
          ...
          <div className="bg-zinc-900 border border-zinc-700 rounded-2xl p-8 w-[500px]">
            ...
            {!revealHint ? (
              ...
              <div>
                ...
                <p className="text-zinc-300 leading-7 mb-6">
                  The shipment logs alone are insufficient.
Join shipment_logs with products using product_id
to uncover the missing inventory category.
                </p>
