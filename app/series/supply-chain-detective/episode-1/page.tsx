...
FROM read_csv_auto('shipment_logs.csv');
    `);
      ...
      <div className="grid grid-cols-12 gap-6 items-start">
        ...
        <div className="col-span-3 bg-zinc-900 rounded-2xl p-6 border border-zinc-800 sticky top-6">
          ...
          <p className="text-zinc-300 leading-8">
            Several high-value shipments marked as delivered
never reached outbound transit. Internal audits
point toward unusual warehouse-level discrepancies.
          </p>
          ...
          <div className="mt-8 bg-black border border-zinc-700 rounded-xl p-4">
            ...
            <p className="text-zinc-300 leading-7">
              Find the warehouse with the highest missing inventory value. Name the value column as lost_value.
            </p>
            ...
            <div className="mt-6">
              ...
              {solved ? (
                ...
                <div className="bg-green-500/10 border border-green-500 rounded-2xl p-6 animate-pulse shadow-lg shadow-green-500/20">
                  ...
                  <p className="text-zinc-300 leading-7">
                    You identified the warehouse responsible for the missing inventory.
                  </p>
                  <button
                  onClick={() =>
  router.push("/series/supply-chain-detective/episode-2")
}
...
>
  Continue to Episode 2 →
                ...
                <div className="bg-red-500/10 border border-red-500 rounded-2xl p-6">
                  ...
                  <p className="text-zinc-300 leading-7">
                    The evidence still doesn't fully match.
                    Recheck the missing inventory patterns.
                  </p>
                ...
                <div className="bg-yellow-500/10 border border-yellow-500 rounded-2xl p-6">
                  ...
                  <p className="text-zinc-300 leading-7">
                    Run your SQL investigation to uncover the warehouse behind the missing inventory.
                  </p>
          ...
          <div className="bg-zinc-900 border border-zinc-700 rounded-2xl p-8 w-[500px]">
            ...
            {!revealHint ? (
              ...
              <div>
                ...
                <p className="text-zinc-300 leading-7 mb-6">
                  Focus only on shipments marked as MISSING.
                  Then aggregate inventory value warehouse-wise and identify the highest total.
                </p>
